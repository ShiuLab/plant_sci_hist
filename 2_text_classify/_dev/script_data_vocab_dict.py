...
07/02/20 Created
03/15/21 Use to get math, stat, and cs entries
'''
...
def help():
    ...
    print('         Need: -o, -t')
    print('      parse_htmls - get item names out from htmls in a folder (-o)')
    print('  -o output directory base name, e.g. vocab_plant')
    print('  -t topic: pln, bmb, gen, bio, evo, eco, mth, sta, or com')
    print('\n\n')
